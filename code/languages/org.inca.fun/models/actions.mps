...
<model ref="r:b56a8750-8e4d-46eb-8117-30c51be7513f(org.inca.fun.actions)">
  ...
  <node concept="1hljLi" id="UgtRGDerEk">
    <property role="TrG5h" value="PasteWrappers" />
    <node concept="1hlzdc" id="UgtRGDerEl" role="1hl$rw">
      <ref role="1hmvP4" to="hqsm:3ybyOPMm8il" resolve="IPatternCall" />
      <ref role="1hszAz" to="ebqt:1i65yRAQ7jk" resolve="IExpression" />
      <node concept="1ht64k" id="UgtRGDerEm" role="1hsNre">
        <node concept="3clFbS" id="UgtRGDerEn" role="2VODD2">
          <node concept="3cpWs6" id="UgtRGDes4f" role="3cqZAp">
            <node concept="2pJPEk" id="UgtRGDest1" role="3cqZAk">
              <node concept="2pJPED" id="UgtRGDesIM" role="2pJPEn">
                <ref role="2pJxaS" to="ebqt:RjyNapPkSs" resolve="PatternFunctionCall" />
                <node concept="2pIpSj" id="UgtRGDesTm" role="2pJxcM">
                  <ref role="2pIpSl" to="ebqt:RjyNaq43ZO" resolve="call" />
                  <node concept="36biLy" id="UgtRGDesYK" role="28nt2d">
                    <node concept="1ht04C" id="UgtRGDesZ2" role="36biLW" />
                  </node>
                </node>
              </node>
            </node>
