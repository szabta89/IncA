...
<model ref="r:17207093-9cf4-4f01-9c48-e6e0146d6087(org.inca.fun.structure)">
  ...
  <node concept="1TIwiD" id="AmUunjSfaU">
    <property role="EcuMT" value="690996766159467194" />
    <property role="3GE5qa" value="statement" />
    <property role="TrG5h" value="SwitchStatementNoOptimizationAttribute" />
    <property role="34LRSv" value="no-optimization" />
    <ref role="1TJDcQ" to="tpck:2ULFgo8_XDk" resolve="NodeAttribute" />
    <node concept="M6xJ_" id="AmUunjSfaV" role="lGtFl">
      <property role="Hh88m" value="noOptimization" />
      <node concept="tn0Fv" id="AmUunjSfaY" role="HhnKV">
        <property role="tnX3d" value="false" />
      </node>
      <node concept="trNpa" id="AmUunjSfb1" role="EQaZv">
        <ref role="trN6q" node="5YhdhgZIEPp" resolve="SwitchStatement" />
      </node>
    </node>
  </node>
